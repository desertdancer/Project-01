 ...
 * @param {object} GRData - object containing Google API data
 */
...
$("#run-search").on("click", function (event) {
  ...
  clear();
  googleBooks()
  // Build the query URL for the ajax request to the Google Books API
...
// function NYTBooks() {
  ...
  // $.get(url).then(function (responseData) {
    ...
    // for (var i = 0; i < books.length; i++) {
      ...
      // $("#NYTBooks").append(`<p>${books[i].title} - ${books[i].author}</p> <br>`)
    // }

  // })
// }
// NYTBooks()
// END OF NYTBOOKS CODE THAT ISABEL HELPED ME WITH ON WED


----------------------------

// I PASTED ALL THE ORIGINAL CODE FROM THE ORIGINAL NYT ACTIVITY TO SEE IF I COULD MODIFY IT TO WORK WITH THE 
// THE NYTBOOKS API AND MY KEY...WHEN I DID THIS, NONE OF THE DATA FROM THE GOOGLE BOOKS APP IS PULLING, SO I AM COMMENTING ALL BELOW OUT
...
// function buildQueryURL() {
 ...
 // queryURL is the url we'll use to query the API
//  var queryURL = "https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=DhrqyjaAn0mxLFOdpPxByhBW2Sxa6XDQ";

 // Begin building an object to contain our API call's query parameters
 // Set the API key
//  var queryParams = { "api-key": "DhrqyjaAn0mxLFOdpPxByhBW2Sxa6XDQ"};
